<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carCheck.aspx.cs" Inherits="SmartHome.carCheck" %>
  ...
  <ul>
       ...
       <li> <a href="maphistory.aspx"><i class="icon icon-pencil"></i> <span>车辆历史轨迹</span></a> </li>    
        ...
        <ul>
            ...
            <li class="active"><a href="carCheck.aspx">用车审批</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="carCheck.aspx" title="用车审批" class="tip-bottom"><i class="icon-cog"></i>用车审批</a></div>
  </div>
<!--End-breadcrumbs-->
