<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SmartHome._default1" %>
...
<!--Header-part-->
<div id="header">
  <h1><a href="index.html">智能家居</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">用户</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a href="#"><i class="icon-user"></i> 简介</a></li>
        <li class="divider"></li>
        <li><a href="#"><i class="icon-check"></i> 事项</a></li>
        <li class="divider"></li>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard11</a>
  <ul>
    <li class="active"><a href="index.html"><i class="icon icon-home"></i> <span>概述</span></a> </li>
    <li> <a href="#"><i class="icon icon-signal"></i> <span>图表</span></a> </li>
    <li> <a href="#"><i class="icon icon-inbox"></i> <span>控制</span></a> </li>
    <li><a href="#"><i class="icon icon-th"></i> <span>数据</span></a></li>
    <li><a href="#"><i class="icon icon-fullscreen"></i> <span>监控</span></a></li>
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>表格</span> <span class="label label-important">3</span></a>
      <ul>
        <li><a href="#">子菜单</a></li>
        <li><a href="#">子菜单</a></li>
        <li><a href="#">子菜单</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="回到主页" class="tip-bottom"><i class="icon-home"></i>概述</a></div>
  </div>
<!--End-breadcrumbs-->
