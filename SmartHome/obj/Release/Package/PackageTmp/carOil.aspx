<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carOil.aspx.cs" Inherits="SmartHome.carOil" %>
       ...
       <li> <a href="maphistory.aspx"><i class="icon icon-pencil"></i> <span>车辆历史轨迹</span></a> </li>
        ...
        <ul>
          ...
          <%--  <li><a href="carMaintain.aspx">维修登记</a></li>
            <li class="active"><a href="carOil.aspx">加油登记</a></li>--%>
        </ul>    
      </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="carOil.aspx" title="加油登记" class="tip-bottom"><i class="icon-cog"></i>加油登记</a></div>
  </div>
<!--End-breadcrumbs-->
    <div class="container-fluid">
         <div style="margin-top:6px;" class="row-fluid">
            <div style="" class="span1 offset11">
                <button id="addBtn" type="button" style="" class="btn btn-mini btn-success">加油登记</button> 
            </div>
        </div>
        <div style="margin-top:0px;" class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <table id="mydatatable" class="table table-bordered table-striped table-hover table-condensed">
                    <thead>
                        <tr>
                              <%--IID, dateTime, plateNumber, runMiles, oilNumber, oilCapacity, cost, oilStation--%>
                            <th>日期时间</th>
                            <th>车牌号码</th>
                            <th>行驶里程</th>
                            <th>油号</th>
                            ...
                            <div id="addCarModalBody" class="modal-body">
                                <form class="form-horizontal">                                   
                                   ...
                                   <div class="form-group">
                                        <label for="plateNumber" class="control-label">车牌号码:</label>
                                        <div class="controls">
                                    ...
                                    <!----------------------------------runMiles----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="runMiles" class="control-label">行驶里程:</label>
                                        <div class="controls">
                                            <input class="form-control" id="runMiles" type="text"/>
                                        </div>
                                    </div>
                                    <!----------------------------------oilNumber----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="oilNumber" class="control-label">油号:</label>
                                        <div class="controls">
                                            <input class="form-control" id="oilNumber" type="text"/>
                                        </div>
                                    </div>
                                    <!----------------------------------oilCapacity----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="oilCapacity" class="control-label">加油量:</label>
                                        <div class="controls">
                                            <input class="form-control" id="oilCapacity" type="text"/>
                                        </div>
                                    </div>
                                    <!----------------------------------cost----------------------------------------------------------->
                                    <div class="form-group">
                                        <label for="cost" class="control-label">金额:</label>
                                        <div class="controls">
                                    ...
                                    <!----------------------------------oilStation----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="oilStation" class="control-label">加油站点:</label>
                                        <div class="controls">
                                            <input class="form-control" id="oilStation" type="text"/>
                                        </div>
                                    </div>
...
<!--end-Footer-part-->
 ...
 <div id="myModal" class="modal fade">
    ...
    <script src="js/carOil.js"></script>
