<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="h5carmanage.aspx.cs" Inherits="SmartHome.h5carmanage" %>
...
<body>
 ...
 <!----------------------------------addName----------------------------------------------------------->  
                                   <div class="form-group">
                                    ...
                                    <!-----------------------------------addCarType---------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="addCarType" class="col-sm-2 control-label">请选择车牌号码:</label>
                                        <div class="col-sm-10">
                                             <select class="form-control" id="addCarType">
      ...
      <%--<button id="cancelAdd" type="reset" class="btn btn-default">取消</button>--%>
     ...
     <%--<div style="background-color:rebeccapurple;margin-top:50px;">h5carmanage</div>--%>
 ...
 <div id="myModal" class="modal fade">
    ...
    <script src="js/h5carmanage.js"></script>
