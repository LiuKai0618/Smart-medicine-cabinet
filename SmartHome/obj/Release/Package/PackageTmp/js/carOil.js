$(function () {
    ...
    $("#saveAdd").on('click', function () {
        ...
        //plateNumber, runMiles, oilNumber, oilCapacity, cost, oilStation
        var plateNumber = $("#plateNumber").val();
        var runMiles = $("#runMiles").val();
        var oilNumber = $("#oilNumber").val();
        var oilCapacity = $("#oilCapacity").val();
        var cost = $("#cost").val();
        var oilStation = $("#oilStation").val();

        //alert(datetime);

        //return;

        if (plateNumber == "" || runMiles == "" || oilNumber == "" || oilCapacity == "" || cost == "" || oilStation == "") {
            alert("请将加油登记信息填写完整！");
            return;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //console.log(data["err_message"]);
                if (data["err_message"]) {
                    $('#jinggaomodel').text('加油登记失败，请重新尝试！');
                    $('#myModal').modal({
                        backdrop: false,
                        keyboard: false,
                        show: true
                    ...
                    loaddata();
                    $('#jinggaomodel').text('加油登记信息已经成功添加！');
                    $('#myModal').modal({
                        backdrop: false,
                        keyboard: false,
                        show: true
