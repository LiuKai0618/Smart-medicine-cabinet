<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carMaintain.aspx.cs" Inherits="SmartHome.carMaintain" %>
  ...
  <ul>
       ...
       <li> <a href="maphistory.aspx"><i class="icon icon-pencil"></i> <span>车辆历史轨迹</span></a> </li>    
        ...
        <ul>
          ...
          <%--  <li class="active"><a href="carMaintain.aspx">维修登记</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="carMaintain.aspx" title="维修登记" class="tip-bottom"><i class="icon-cog"></i>维修登记</a></div>
  </div>
<!--End-breadcrumbs-->
    <div class="container-fluid">
        <div style="margin-top:6px;" class="row-fluid">
            <div style="" class="span1 offset11">
                <button id="addBtn" type="button" style="" class="btn btn-mini btn-success">维修登记</button> 
            </div>
        </div>
                            ...
                            <div id="addCarModalBody" class="modal-body">
                                <form class="form-horizontal">                                   
                                   ...
                                   <div class="form-group">
                                        <label for="addBrand" class="control-label">车牌号码:</label>
                                        <div class="controls">
                                            <select id="addBrand">
                                      ...
                                      <!----------------------------------driver----------------------------------------------------------->  
                                    <div class="form-group">
                                        <label for="addDriver" class="control-label">申请人:</label>
                                        <div class="controls">
                                            <select id="addDriver">
                                             <%--   <option value="1">1</option>
                                                <option value="2">2</option>--%>
                                    ...
                                    <!----------------------------------dateTime----------------------------------------------------------> 
                                     <%-- <div class="form-group">
                                        <label for="addDateTime" class="control-label">申请时间:</label>
                                        <div class="controls">
                                            <input class="form-control" id="addDateTime" type="date"/>
                                        </div>
                                    </div>--%>
                                    <!----------------------------------maintainDep----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="addMaintainDep" class="control-label">维修部门:</label>
                                        <div class="controls">
                                            <input class="form-control" id="addMaintainDep" type="text"/>
                                        </div>
                                    </div>
                                    <!----------------------------------maintainItem----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="addMaintainItem" class="control-label">维修项目:</label>
                                        <div class="controls">
                                            <input class="form-control" id="addMaintainItem" type="text"/>
                                        </div>
                                    </div>
                                    <!----------------------------------orderNumber----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="addOrderNumber" class="control-label">订单号:</label>
                                        <div class="controls">
                                            <input class="form-control" id="addOrderNumber" type="text"/>
                                        </div>
                                    </div>
                                    <!----------------------------------cost----------------------------------------------------------->
                                    <div class="form-group">
                                        <label for="addCost" class="control-label">费用:</label>
                                        <div class="controls">
                                            <input class="form-control" id="addCost" type="text"/>
                                        </div>
                                    </div>
                                    <!----------------------------------carState----------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="addCarState" class="control-label">车辆状态:</label>
                                        <div class="controls">
                                            <input class="form-control" id="addCarState" type="text"/>
                                        </div>
                                    </div>
...
<!--end-Footer-part-->
 ...
 <div id="myModal" class="modal fade">
    ...
    <script src="js/carMaintain.js"></script>
