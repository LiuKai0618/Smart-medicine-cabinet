<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carManage.aspx.cs" Inherits="SmartHome.carManage" %>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard11</a>
  <ul>
       ...
       <li> <a href="carMaphistory.aspx"><i class="icon icon-pencil"></i> <span>查看车辆历史轨迹</span></a> </li>
        ...
        <ul>
            <li class="active"><a href="carManage.aspx">用车申请</a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="carManage.aspx" title="用车申请" class="tip-bottom"><i class="icon-cog"></i>用车申请</a></div>
  </div>
<!--End-breadcrumbs-->
    <div class="container-fluid">
         <div style="margin-top:6px;" class="row-fluid">
            <div style="" class="span1 offset11">
                <button id="addBtn" type="button" style="" class="btn btn-mini btn-success">申请用车</button> 
            </div>
        </div>
        <div style="margin-top:0px;" class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <table id="mydatatable" class="table table-bordered table-striped table-hover table-condensed">
                    ...
                    <tbody id="rtu2mms">
                        <tr><td colspan='8' style='text-align:center;font-size:10px;font-weight:bold;color:#666666;background:#efefef'>表 格 数 据 为 空！</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
                            ...
                            <div id="addCarModalBody" class="modal-body">
                                <form class="form-horizontal">                                   
                                   ...
                                   <div class="form-group">
                                    ...
                                    <!-----------------------------------addDateTime---------------------------------------------------------->
                                     <div class="form-group">
                                        <label for="addDateTime" class="control-label">用车日期:</label>
                                        <div class="controls">
                                    ...
                                    <!------------------------------------addFromTo--------------------------------------------------------->
                                     <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input class="form-control" id="addFrom" type="text" placeholder="请输入起始地点"/>
                                            <input class="form-control" id="addTo" type="text" placeholder="请输入目的地点"/>
                                        </div>
                                    </div>
                                    <!-----------------------------------addCellPhone---------------------------------------------------------->
                                    <div class="form-group">
