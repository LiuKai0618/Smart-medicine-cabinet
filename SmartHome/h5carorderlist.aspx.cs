...
namespace SmartHome
{
    public partial class h5carorderlist : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (userlevel == "0")
            {
                this.welcome.InnerText = "历史订单[超级管理员:" + username + "]";
                //this.loginuser.InnerText = "超级管理员：" + username;
            }
            else if (userlevel == "1")
            {
                this.welcome.InnerText = "历史订单[管理员:" + username + "]";
                //this.loginuser.InnerText = "管理员：" + username;
                //Response.Redirect("login.html");
            }
            else
            {
                this.welcome.InnerText = "历史订单[用户:" + username + "]";
